                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="icheck-primary d-inline">
                                            <input type="radio" id="radioPrimary1" name="status" value="1" {{ $user->status == 1 ? 'checked' : '' }}>
                                            <label for="radioPrimary1">
                                                Hoạt động
                                            </label>
                                        </div>
                                        <div class="icheck-primary d-inline" style="margin-left: 30px;">
                                            <input type="radio" id="radioPrimary2" name="status" value="2" {{ $user->status == 2 ? 'checked' : '' }}>
